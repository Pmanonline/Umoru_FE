...
//   const [loading, setLoading] = useState(true); // Fixed: was an array, should be boolean
...
//       setBusinesses(data.data || []); // Set businesses directly from data.data
//     } catch (err) {
...
//   // No filtering needed since API returns business data directly
...
//       navigator
//         .share({
//           title: business.business_name, // Updated to match response structure
//           text: `Check out ${business.business_name} on our platform!`,
...
//               key={business.id}
//               business={business}
//               onShare={() => handleShare(business)} // Pass share handler if needed by BusinessCard
//             />
//           ))}
//         </div>
...
const RecommendedBusinesses = () => {
  ...
  const handleShare = (business) => {
    if (navigator.share) {
      navigator
        .share({
          title: business.name, // Uses formatted name
