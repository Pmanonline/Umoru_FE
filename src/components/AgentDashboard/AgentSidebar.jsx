...
import { MdInventory, MdPayments, MdLocalShipping } from "react-icons/md";
...
const AgentSidebar = () => {
  ...
  const profile = userInfo?.vendorProfile || {};
  ...
  const mainLinks = [
    ...
    { path: "/Agent/dashboard", icon: VscDashboard, label: "Dashboard" },
    { path: "/Agent/profile", icon: IoPerson, label: "Profile" },
    { path: "/Agent/store", icon: FaStore, label: "My Store" },
  ];

  const businessLinks = [
    { path: "/Agent/orders", icon: FaTags, label: "Orders" },
    { path: "/Agent/analytics", icon: FaChartLine, label: "Analytics" },
    { path: "/Agent/payments", icon: MdPayments, label: "Payments" },
    { path: "/Agent/reviews", icon: BiCommentDetail, label: "Reviews" },
    {
      ...
      <div
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-5">
            ...
            <p className="text-sm text-blue-200 mb-6">Agent Dashboard</p>
            {!isSmallScreen && (
              <div className="flex items-center">
                <span className="mb-2">
                  {profile?.image ? (
