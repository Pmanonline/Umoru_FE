...
//     { path: "/user/profile", icon: IoPerson, label: "My Profile" },
//     { path: "/user/reviews", icon: BiCommentDetail, label: "My Reviews" },
//     { path: "/user/payments", icon: MdPayments, label: "Payment Methods" },
//     { path: "/user/addresses", icon: MdLocationOn, label: "My Addresses" },
...
//             </Link>
//             <p className="text-sm text-blue-200 mb-6">My Dashboard</p>
//             {!isSmallScreen && (
//               <div className="flex items-center">
//                 <span className="mb-2">
//                   {profile?.image ? (
...
const UserSidebar = () => {
  ...
  const sidebarLinks = [
    { path: "/user/MyDashBoad", icon: FaHome, label: "My Dashboard" },
    { path: "/user/profile", icon: IoPerson, label: "My Profile" },
    { path: "/user/reviews", icon: BiCommentDetail, label: "My Reviews" },
    { path: "/user/payments", icon: MdPayments, label: "Payment Methods" },
    { path: "/user/addresses", icon: MdLocationOn, label: "My Addresses" },
