...
const StatCard = ({ title, number, description, className = "" }) => (
  <div className={`p-6 rounded-lg shadow-sm ${className}`}>
    ...
    <h3 className="text-4xl font-bold text-center mb-3">{number}</h3>
...
export const Ebusinesses = ({ userInfo }) => (
  <div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center p-6">
            <div className="w-full md:w-1/2 pr-0 md:pr-6">
              ...
              <Link target="_blank" to={"https://edirect.essential.ng/"}>
                <button className="flex items-center justify-center relative bg-red-600 text-white px-4 py-2 rounded overflow-hidden transition-all duration-300 hover:rotate-2 hover:bg-red-700 hover:ring-2 hover:ring-white">
                  <span className="mr-2">Register Now</span> <MdPersonAddAlt1 />
                </button>
              </Link>
            </div>
