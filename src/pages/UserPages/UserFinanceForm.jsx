...
//   // Form submission handler - defined inside component because it uses state
...
//   // Combined data fetch function - handles both user slug and finance data
//   useEffect(() => {
...
//         // Step 2: Fetch finance data with the slug
...
//     fetchData();
//   }, [userInfo?.slug, token.token]); // Minimal dependencies to avoid re-runs
...
//   return (
//     <div className="max-w-screen-xl mx-auto px-2 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8">
...
//               <button
//                 type="submit"
//                 disabled={loading || submitLoading} // Disable for either loading state
...
// Fallback Loading Spinner (replace with loadingSpinner2 if fixed)
...
const UserFinanceForm = React.memo(() => {
  ...
  const formik = useFormik({
    ...
    validationSchema,
    onSubmit: useCallback(handleSubmitForm, [token.token]), // Memoize onSubmit
  });
