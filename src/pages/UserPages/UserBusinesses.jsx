...
// const BACKEND_URL = "https://backend.edirect.ng";
...
//       setLoading(false);
//     }
//   }, [token.token, userInfo?.slug, showAlertMessage]);
...
//       setLoading(true);
//       const response = await fetch(
//         `${BACKEND_URL}/api/business/${businessToDelete.id}`,
//         {
//           method: "DELETE",
//           headers: { Authorization: `Bearer ${token.token}` },
//         }
...
//       showAlertMessage("Business deleted successfully!", "success");
//     } catch (error) {
//       showAlertMessage(error.message, "destructive");
//     } finally {
//       setLoading(false);
