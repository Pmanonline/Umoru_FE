...
// // Placeholder profile image (replace with actual URL if available)
...
//       <div className="bg-gradient-to-r from-red-600 to-blue-700 rounded-2xl shadow-2xl text-white overflow-hidden">
...
//                 <span>{profile.current_place_of_work || "Not specified"}</span>
//               </div>
...
//                   <p className="font-medium">{maskEmail(profile.email)}</p>
//                 </div>
//               </div>
...
//                       className="flex items-center gap-4 p-4 bg-purple-50 rounded-xl mb-3 text-blue-600 hover:underline">
...
//                   value={profile.number_of_children ?? "N/A"}
//                 />
//                 <DetailItem
...
//                   value={profile.current_place_of_work || "N/A"}
//                 />
//                 <DetailItem
//                   icon={<Briefcase className="w-6 h-6 text-orange-500" />}
//                   label="Last Workplace"
//                   value={profile.last_place_of_work || "N/A"}
//                 />
//                 <DetailItem
...
//               <button
//                 onClick={handleShare}
//                 className="flex items-center justify-center gap-2 w-full bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-xl transition-colors font-semibold">
//                 <Share2 size={20} />
//                 Share Profile
//               </button>
//               <button className="flex items-center justify-center gap-2 w-full bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-xl transition-colors font-semibold">
//                 <MessageCircle size={20} />
//                 Send Message
//               </button>
//               <button className="flex items-center justify-center gap-2 w-full bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-xl transition-colors font-semibold">
//                 <Flag size={20} />
//                 Report Profile
//               </button>
//               <Link
//                 to="/searchPage/people"
//                 className="flex items-center justify-center gap-2 w-full bg-gray-100 hover:bg-gray-200 px-6 py-3 rounded-xl transition-colors text-gray-700 font-semibold">
//                 Back to Search
//               </Link>
//             </div>
//           </div>
...
//         <Link
//           to="/searchPage/people"
//           className="inline-flex items-center gap-2 text-blue-600 hover:text-blue-800 font-medium p-2">
//           <ChevronLeft size={20} />
//           Back to Search
//         </Link>
//       </div>
...
//       {/* Profile Header */}
//       <div className="bg-gradient-to-r from-blue-700 to-purple-700 rounded-2xl shadow-xl overflow-hidden mb-8">
...
//             <div className="flex flex-wrap items-center gap-y-3 gap-x-4 justify-center md:justify-start text-white/90 mb-4">
...
//                         target="_blank"
//                         rel="noopener noreferrer"
//                         className="flex items-center gap-3 p-3 bg-purple-50 rounded-lg text-blue-600 hover:bg-purple-100 transition-colors">
//                         <Globe size={18} />
...
import LoadingSpinner from "../components/tools/LoaddingSpinner"; // Assuming typo fixed to "LoadingSpinner"
