        ...
        <div className="absolute bottom-0 max-w-4xl mid:top-0 left-0 right-0 p-6 lg:p-8 text-white">
          <div className="max-w-6xl mx-auto">
            <div className="flex items-center justify-between mb-4">
              <span
                className={`bg-primary text-white text-sm px-4 py-1 rounded-full uppercase font-semibold tracking-wide`}>
...
const DefaultAvatar = ({ username, size = "md" }) => {
  ...
  return (
    <div
      className={`bg-gradient-to-br from-teal-500 to-primary rounded-full flex items-center justify-center ring-2 ring-gray-200 dark:ring-gray-600 text-white font-medium ${sizes[size]}`}>
      {initials}
    </div>
  );
};
