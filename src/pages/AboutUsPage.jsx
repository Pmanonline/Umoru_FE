...
const AboutUsPage = () => {
  ...
  return (
    <section className="relative py-16 bg-gradient-to-br from-primary/90 via-teal-900 to-black/30 dark:from-primary-dark/80 dark:via-teal-900 dark:to-black ">
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8  max-w-6xl">
        <div className="flex flex-col lg:flex-row items-center gap-12 mb-16 mt-6">
          <motion.div
            ref={imageRef}
          ...
          <motion.div
            ...
            <motion.h2
              className="text-4xl sm:text-5xl font-bold mb-6 text-secondary dark:text-secondary-light"
              variants={fadeInVariants}>
              Segun Umoru
            </motion.h2>
            <motion.p
              className="text-lg sm:text-xl mb-6 text-gray-100 dark:text-gray-200"
              variants={fadeInVariants}>
              Segun Umoru is a visionary leader dedicated to empowering
              individuals and organizations through data-driven insights and
              holistic personal development. With a unique blend of expertise in
            ...
            <motion.a
              href="/services"
              className="inline-block bg-secondary hover:bg-secondary-light dark:bg-secondary-dark dark:hover:bg-secondary text-white py-3 px-6 rounded-full font-semibold transition-all duration-300 shadow-md hover:shadow-secondary/30"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              variants={fadeInVariants}>
              Explore Services
        ...
        <motion.div
          ...
          variants={fadeInVariants}>
          <motion.h3
            className="text-3xl sm:text-4xl font-semibold text-secondary dark:text-secondary-light mb-6"
            variants={fadeInVariants}>
            Biography
          </motion.h3>
          <motion.p
            className="text-lg sm:text-xl text-gray-100 dark:text-gray-200"
            variants={fadeInVariants}>
            Born and raised in Lagos, Nigeria, Segun Umoru developed an early
            passion for problem-solving and human connection. His curiosity for
            technology and spirituality shaped his multifaceted career. Over the
        ...
        <motion.div
          ...
          <motion.ul
            className="list-disc list-inside text-lg sm:text-xl text-gray-100 dark:text-gray-200 space-y-4"
            variants={listVariants}
            initial="hidden"
            animate={achievementsInView ? "visible" : "hidden"}>
            <motion.li variants={listItemVariants}>
        ...
        <motion.div
          ...
          <motion.p
            className="text-lg sm:text-xl text-gray-100 dark:text-gray-200 mb-6"
            variants={fadeInVariants}>
            Segun's work has made a tangible impact, both in the tech industry
            and in the lives of those he coaches. His data-driven solutions have
            powered business growth, while his coaching programs have
        ...
        <motion.div
          ...
          <motion.p
            className="text-lg sm:text-xl text-gray-100 dark:text-gray-200 mb-8"
            variants={fadeInVariants}>
            Whether you're seeking data-driven solutions or personal growth,
            Segun Umoru is here to guide you. Connect with him today to explore
            how his expertise can empower your future.
